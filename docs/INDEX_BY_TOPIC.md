...
- [Bulk Operations Printable Field Tracking](./enhancements/BULK_OPERATIONS_PRINTABLE_FIELD_TRACKING.md)
- [Checkbox Field - Inline Edit Feature](./enhancements/CHECKBOX_INLINE_EDIT_FEATURE.md)
...
- [Operator Monitoring Descriptions Enhancement](./enhancements/OPERATOR_MONITORING_DESCRIPTIONS_ENHANCEMENT.md)
...
- [Access Control Table ID Validation Fix](./fixes/ACCESS_CONTROL_TABLE_ID_VALIDATION_FIX.md)
- [Advanced Filter Dropdown Scrolling Fix](./fixes/ADVANCED_FILTER_DROPDOWN_SCROLLING_FIX.md)
- [Approval Profiles API Null-Safety and API Standardization Fix](./fixes/APPROVAL_PROFILES_API_NULL_SAFETY_FIX.md)
- [Approval Profiles Authorization Bypass Fix](./fixes/APPROVAL_PROFILES_AUTHORIZATION_FIX.md)
- [Appwrite Attribute Polling Fix](./fixes/APPWRITE_ATTRIBUTE_POLLING_FIX.md)
- [Appwrite TablesDB API Migration to Named Parameters](./fixes/APPWRITE_TABLESDB_API_MIGRATION_FIX.md)
- [Appwrite TablesDB Test Migration](./fixes/APPWRITE_TABLESDB_TEST_MIGRATION.md)
- [Attendee API Sensitive Error Exposure Fix](./fixes/ATTENDEE_API_SENSITIVE_ERROR_EXPOSURE_FIX.md)
- [Attendee API TablesDB Positional Parameters Fix](./fixes/ATTENDEE_API_TABLESDB_POSITIONAL_PARAMS_FIX.md)
...
- [Bulk Credential Photo Concurrency Fix](./fixes/BULK_CREDENTIAL_PHOTO_CONCURRENCY_FIX.md)
- [Bulk Delete Timestamp Attribute Fix](./fixes/BULK_DELETE_TIMESTAMP_FIX.md)
- [Bulk Operation Broadcast localStorage Race Condition Fix](./fixes/BULK_OPERATION_BROADCAST_LOCALSTORAGE_RACE_CONDITION_FIX.md)
- [Bulk Operation Broadcast Singleton Configuration Fix](./fixes/BULK_OPERATION_BROADCAST_SINGLETON_CONFIG_FIX.md)
- [Bulk Operations Error Handling Fix](./fixes/BULK_OPERATIONS_ERROR_HANDLING_FIX.md)
- [Bulk Operations Error Retryability Detection Fix](./fixes/BULK_OPERATIONS_ERROR_RETRYABILITY_DETECTION_FIX.md)
- [Bulk Operations ID Overwrite Fix](./fixes/BULK_OPERATIONS_ID_OVERWRITE_FIX.md)
- [Clear Event Settings Infinite Loop Fix](./fixes/CLEAR_EVENT_SETTINGS_INFINITE_LOOP_FIX.md)
- [Code Review Fixes Session Complete](./fixes/CODE_REVIEW_FIXES_SESSION_COMPLETE.md)
- [Code Review Issues Comprehensive Fix](./fixes/CODE_REVIEW_ISSUES_COMPREHENSIVE_FIX.md)
- [Code Review Issues Resolution](./fixes/CODE_REVIEW_ISSUES_RESOLUTION.md)
- [Code Review Issues Resolution Summary](./fixes/CODE_REVIEW_ISSUES_RESOLUTION_SUMMARY.md)
...
- [Credential Generation Type Safety Fix](./fixes/CREDENTIAL_GENERATION_TYPE_SAFETY_FIX.md)
...
- [Custom Field Internal Names Implementation](./fixes/CUSTOM_FIELD_INTERNAL_NAMES_IMPLEMENTATION.md)
- [Custom Field Storage Format Consistency Fix](./fixes/CUSTOM_FIELD_STORAGE_FORMAT_CONSISTENCY_FIX.md)
...
- [JSON Parsing Error Handling Fix](./fixes/JSON_PARSING_ERROR_HANDLING_FIX.md)
- [Load Report Delete Race Condition Fix](./fixes/LOAD_REPORT_DELETE_RACE_CONDITION_FIX.md)
- [Load Report Edit Form Duplicate Submission Fix](./fixes/LOAD_REPORT_EDIT_FORM_DUPLICATE_SUBMISSION_FIX.md)
...
- [Mock Query Permission Escaping Fix](./fixes/MOCK_QUERY_PERMISSION_ESCAPING_FIX.md)
- [Monitoring API Permission Fix](./fixes/MONITORING_API_PERMISSION_FIX.md)
- [Multi-Select Filter Implementation Summary](./fixes/MULTI_SELECT_IMPLEMENTATION_SUMMARY.md)
- [Optimistic Lock retriesUsed Accuracy Fix](./fixes/OPTIMISTIC_LOCK_RETRIES_USED_ACCURACY_FIX.md)
...
- [Pagination Offset Deletion Bug Fix](./fixes/PAGINATION_OFFSET_DELETION_BUG_FIX.md)
...
- [Report Correction JSON Parse Optimization](./fixes/REPORT_CORRECTION_JSON_PARSE_OPTIMIZATION.md)
- [Report Correction Replacement Dropdown Fix](./fixes/REPORT_CORRECTION_REPLACEMENT_DROPDOWN_FIX.md)
- [Report Correction Silent Replacement Failure Fix](./fixes/REPORT_CORRECTION_SILENT_REPLACEMENT_FAILURE_FIX.md)
- [Report Correction Stale Field Removal Fix](./fixes/REPORT_CORRECTION_STALE_FIELD_REMOVAL_FIX.md)
- [Resizable Component Ref Override Fix](./fixes/RESIZABLE_COMPONENT_REF_OVERRIDE_FIX.md)
- [Role Permissions Validation Fix](./fixes/ROLE_PERMISSIONS_VALIDATION_FIX.md)
- [Roles Page Redesign Restoration](./fixes/ROLES_PAGE_REDESIGN_RESTORATION.md)
- [Saved Reports Custom Field Validation Fix](./fixes/SAVED_REPORTS_CUSTOM_FIELD_VALIDATION_FIX.md)
- [Saved Reports Duplicate Name Handling Fix](./fixes/SAVED_REPORTS_DUPLICATE_NAME_HANDLING_FIX.md)
- [Saved Reports Empty Custom Fields Fix](./fixes/SAVED_REPORTS_EMPTY_CUSTOM_FIELDS_FIX.md)
- [Saved Reports Malformed filterConfiguration Fix](./fixes/SAVED_REPORTS_MALFORMED_FILTERCONFIGURATION_FIX.md)
- [Saved Reports Permission Fix](./fixes/SAVED_REPORTS_PERMISSION_FIX.md)
- [TablesDB Migration Stale References Fix](./fixes/TABLESDB_MIGRATION_STALE_REFERENCES_FIX.md)
- [Test Files API Consistency and Indentation Fixes](./fixes/TEST_FILES_API_CONSISTENCY_FIX.md)
- [Transaction Monitoring Dashboard Empty-State Logic Fix](./fixes/TRANSACTION_MONITORING_EMPTY_STATE_LOGIC_FIX.md)
- [useUserFormState Test Expectations Fix](./fixes/USEFORMSTATE_TEST_EXPECTATIONS_FIX.md)
...
- [Appwrite Transactions Best Practices](./guides/TRANSACTIONS_BEST_PRACTICES.md)
- [Appwrite Transactions Code Examples](./guides/TRANSACTIONS_CODE_EXAMPLES.md)
- [Appwrite Transactions Developer Guide](./guides/TRANSACTIONS_DEVELOPER_GUIDE.md)
...
- [Comprehensive Transactions Analysis for CredentialStudio](./guides/TRANSACTIONS_COMPREHENSIVE_ANALYSIS.md)
- [CredentialStudio Manual Testing Guide](./guides/MANUAL_TESTING_GUIDE.md)
- [Custom Field Columns - Quick Reference](./guides/CUSTOM_FIELD_COLUMNS_QUICK_REFERENCE.md)
- [Custom Field Columns - Visual Guide](./guides/CUSTOM_FIELD_COLUMNS_VISUAL_GUIDE.md)
...
- [Event Settings Cache Usage Example](./guides/CACHE_USAGE_EXAMPLE.md)
- [Field Update Service Guide](./guides/FIELD_UPDATE_SERVICE_GUIDE.md)
...
- [Integration Migration Patterns](./guides/INTEGRATION_MIGRATION_PATTERNS.md)
...
- [Mobile Custom Fields Enhancement Summary](./guides/MOBILE_CUSTOM_FIELDS_ENHANCEMENT.md)
- [Mobile Settings Passcode Implementation Guide](./guides/MOBILE_SETTINGS_PASSCODE_IMPLEMENTATION_GUIDE.md)
- [Multi-Tenancy Setup Guide](./guides/MULTI_TENANCY_SETUP_GUIDE.md)
- [Operator Monitoring User Guide](./guides/OPERATOR_MONITORING_USER_GUIDE.md)
- [Package Updates Quick Reference](./guides/PACKAGE_UPDATES_QUICK_REFERENCE.md)
...
- [Printable Fields User Guide](./guides/PRINTABLE_FIELDS_USER_GUIDE.md)
- [Saved Reports Feature Guide](./guides/SAVED_REPORTS_GUIDE.md)
- [SweetAlert2 Best Practices Guide](./guides/SWEETALERT_BEST_PRACTICES_GUIDE.md)
- [SweetAlert2 Customization Guide](./guides/SWEETALERT_CUSTOMIZATION_GUIDE.md)
- [SweetAlert2 Usage Guide](./guides/SWEETALERT_USAGE_GUIDE.md)
...
- [Appwrite TablesDB API Migration to Named Parameters](./migration/APPWRITE_TABLESDB_API_MIGRATION.md)
- [Complete Backend Migration Guide: Supabase to Appwrite](./migration/COMPLETE_MIGRATION_GUIDE.md)
- [Custom Fields Visibility Control Migration](./migration/CUSTOM_FIELDS_VISIBILITY_MIGRATION.md)
- [Event Settings Migration - Complete Summary](./migration/MIGRATION_COMPLETE_SUMMARY.md)
- [Event Settings Migration Schema](./migration/EVENT_SETTINGS_MIGRATION_SCHEMA.md)
- [Event Settings Migration Status](./migration/MIGRATION_STATUS.md)
- [Integration Collections Migration](./migration/INTEGRATION_COLLECTIONS_MIGRATION.md)
- [Integration Secrets Migration Guide](./migration/INTEGRATION_SECRETS_MIGRATION.md)
- [Integration Version Attribute Implementation Summary](./migration/INTEGRATION_VERSION_ATTRIBUTE_SUMMARY.md)
- [Integration Version Migration](./migration/INTEGRATION_VERSION_MIGRATION.md)
- [Log Settings Table Schema Migration](./migration/LOG_SETTINGS_SCHEMA_MIGRATION.md)
- [Logs Timestamp Migration Summary](./migration/LOGS_TIMESTAMP_MIGRATION_SUMMARY.md)
- [Migration Lessons Learned](./migration/MIGRATION_LESSONS_LEARNED.md)
...
- [TablesDB Setup Scripts Migration](./migration/TABLESDB_SETUP_SCRIPTS_MIGRATION.md)
- [Vitest 4.0.18 Upgrade Analysis](./migration/VITEST_4_0_18_UPGRADE_ANALYSIS.md)
- [Vitest 4.0.18 Upgrade Summary](./migration/VITEST_4_UPGRADE_SUMMARY.md)

### Misc (18)

- [Advanced Filters Component Extraction and Redesign](./misc/ADVANCED_FILTERS_COMPONENT_EXTRACTION_REFACTOR.md)
- [Bulk Credential Photo Concurrency Fix Verification](./misc/BULK_CREDENTIAL_PHOTO_CONCURRENCY_VERIFICATION.md)
...
- [Link User Integration Guide](./misc/LINK_USER_INTEGRATION.md)
- [Log Truncation Utility Refactor](./misc/LOG_TRUNCATION_REFACTOR.md)
- [Major Package Updates Testing Complete](./misc/MAJOR_PACKAGE_UPDATES_TESTING_COMPLETE.md)
- [Major Package Updates Testing Plan](./misc/MAJOR_PACKAGE_UPDATES_TESTING_PLAN.md)
- [Major Updates Findings and Recommendations](./misc/MAJOR_UPDATES_FINDINGS_AND_RECOMMENDATIONS.md)
- [Package Updates Analysis](./misc/PACKAGE_UPDATES_ANALYSIS.md)
- [Package Updates Completion Summary](./misc/PACKAGE_UPDATES_COMPLETION_SUMMARY.md)
- [Role User Count Caching Implementation](./misc/ROLE_USER_COUNT_CACHE.md)
- [Session Summary - Dependency Updates & Vitest Upgrade](./misc/SESSION_SUMMARY_DEPENDENCY_UPDATES.md)
- [Setup Appwrite Helper Extraction](./misc/SETUP_APPWRITE_HELPER_EXTRACTION.md)
- [TablesDB Atomic Bulk Operations - Correct Implementation](./misc/TABLESDB_ATOMIC_OPERATIONS.md)
- [TablesDB: updateRows vs upsertRows - Critical Difference](./misc/TABLESDB_UPDATE_VS_UPSERT.md)
- [User Management Enhancement for Appwrite](./misc/USER_MANAGEMENT_ENHANCEMENT.md)

### Reference (3)

- [API Transactions Reference](./reference/API_TRANSACTIONS_REFERENCE.md)
- [Log Settings to Action Mapping](./reference/LOG_SETTINGS_MAPPING.md)
- [Mobile API Reference](./reference/MOBILE_API_REFERENCE.md)

### Testing (23)

- [Attendee Management API Tests Summary](./testing/ATTENDEE_API_TESTS_SUMMARY.md)
- [Auth User Linking Integration Tests Summary](./testing/AUTH_USER_LINKING_INTEGRATION_TESTS_SUMMARY.md)
- [Custom Field API Tests Summary](./testing/CUSTOM_FIELD_API_TESTS_SUMMARY.md)
- [Custom Field Columns Configuration - Testing Checklist](./testing/CUSTOM_FIELD_COLUMNS_TESTING_CHECKLIST.md)
- [End-to-End Tests Summary](./testing/E2E_TESTS_SUMMARY.md)
- [Framer Motion 12.29.2 Update Test Results](./testing/FRAMER_MOTION_UPDATE_TEST_RESULTS.md)
- [Invitation API Tests Summary](./testing/INVITATION_API_TESTS_SUMMARY.md)
- [Log Deletion Testing Guide](./testing/LOG_DELETION_TESTING_GUIDE.md)
- [Logging System Integration Tests - Implementation Summary](./testing/LOGS_API_TESTS_SUMMARY.md)
- [Mobile Settings Passcode - Test Summary](./testing/MOBILE_SETTINGS_PASSCODE_TESTS_SUMMARY.md)
- [Node-Appwrite 21.1.0 Update Test Results](./testing/NODE_APPWRITE_UPDATE_TEST_RESULTS.md)
- [Notes Search Functionality Tests Summary](./testing/NOTES_SEARCH_TESTS_SUMMARY.md)
- [Notes Search Visual Design and Accessibility Verification](./testing/NOTES_SEARCH_VISUAL_ACCESSIBILITY_VERIFICATION.md)
- [OneSimpleAPI HTML Sanitization Tests Summary](./testing/ONESIMPLEAPI_SANITIZATION_TESTS_SUMMARY.md)
- [Quick Start: Testing Delete Logs](./testing/TESTING_QUICK_START.md)
- [Quick Test Guide](./testing/QUICK_TEST_GUIDE.md)
- [Real-time Functionality Tests Summary](./testing/REALTIME_TESTS_SUMMARY.md)
- [Role and Permission API Tests Summary](./testing/ROLE_API_TESTS_SUMMARY.md)
- [Running Integration Tests](./testing/RUNNING_INTEGRATION_TESTS.md)
- [TablesDB Migration Property Tests Summary](./testing/TABLESDB_MIGRATION_PROPERTY_TESTS_SUMMARY.md)
- [Transactions & Bulk Operations - Comprehensive Test Plan](./testing/TRANSACTIONS_TEST_PLAN.md)
- [User Management API Integration Tests Summary](./testing/USER_MANAGEMENT_API_TESTS_SUMMARY.md)
- [UserForm Testing Summary](./testing/USERFORM_TESTING_SUMMARY.md)
...
- [Access Control Table ID Validation Fix](./fixes/ACCESS_CONTROL_TABLE_ID_VALIDATION_FIX.md) - fixes
...
- [Approval Profiles API Null-Safety and API Standardization Fix](./fixes/APPROVAL_PROFILES_API_NULL_SAFETY_FIX.md) - fixes
- [Approval Profiles Authorization Bypass Fix](./fixes/APPROVAL_PROFILES_AUTHORIZATION_FIX.md) - fixes
...
- [Appwrite TablesDB API Migration to Named Parameters](./fixes/APPWRITE_TABLESDB_API_MIGRATION_FIX.md) - fixes
- [Appwrite TablesDB Test Migration](./fixes/APPWRITE_TABLESDB_TEST_MIGRATION.md) - fixes
- [Appwrite Transactions Best Practices](./guides/TRANSACTIONS_BEST_PRACTICES.md) - guides
...
- [Attendee API Sensitive Error Exposure Fix](./fixes/ATTENDEE_API_SENSITIVE_ERROR_EXPOSURE_FIX.md) - fixes
- [Attendee API TablesDB Positional Parameters Fix](./fixes/ATTENDEE_API_TABLESDB_POSITIONAL_PARAMS_FIX.md) - fixes
...
- [Bulk Credential Photo Concurrency Fix](./fixes/BULK_CREDENTIAL_PHOTO_CONCURRENCY_FIX.md) - fixes
- [Bulk Credential Photo Concurrency Fix Verification](./misc/BULK_CREDENTIAL_PHOTO_CONCURRENCY_VERIFICATION.md) - misc
...
- [Bulk Operation Broadcast localStorage Race Condition Fix](./fixes/BULK_OPERATION_BROADCAST_LOCALSTORAGE_RACE_CONDITION_FIX.md) - fixes
- [Bulk Operation Broadcast Singleton Configuration Fix](./fixes/BULK_OPERATION_BROADCAST_SINGLETON_CONFIG_FIX.md) - fixes
- [Bulk Operations - Canonical Implementation](./misc/BULK_OPERATIONS_CANONICAL.md) - misc
- [Bulk Operations Error Handling Fix](./fixes/BULK_OPERATIONS_ERROR_HANDLING_FIX.md) - fixes
- [Bulk Operations Error Retryability Detection Fix](./fixes/BULK_OPERATIONS_ERROR_RETRYABILITY_DETECTION_FIX.md) - fixes
- [Bulk Operations ID Overwrite Fix](./fixes/BULK_OPERATIONS_ID_OVERWRITE_FIX.md) - fixes
- [Bulk Operations Performance](./guides/BULK_OPERATIONS_PERFORMANCE.md) - guides
- [Bulk Operations Printable Field Tracking](./enhancements/BULK_OPERATIONS_PRINTABLE_FIELD_TRACKING.md) - enhancements
- [Cache Memory Management Enhancement](./misc/CACHE_MEMORY_MANAGEMENT_ENHANCEMENT.md) - misc
- [Cache Usage Guide](./guides/CACHE_USAGE_GUIDE.md) - guides
- [Checkbox Field - Inline Edit Feature](./enhancements/CHECKBOX_INLINE_EDIT_FEATURE.md) - enhancements
- [Checkbox Field Yes/No Format](./enhancements/CHECKBOX_FIELD_YES_NO_FORMAT.md) - enhancements
- [Clear Event Settings Infinite Loop Fix](./fixes/CLEAR_EVENT_SETTINGS_INFINITE_LOOP_FIX.md) - fixes
- [Code Review Issues Comprehensive Fix](./fixes/CODE_REVIEW_ISSUES_COMPREHENSIVE_FIX.md) - fixes
- [Code Review Issues Resolution](./fixes/CODE_REVIEW_ISSUES_RESOLUTION.md) - fixes
- [Code Review Issues Resolution Summary](./fixes/CODE_REVIEW_ISSUES_RESOLUTION_SUMMARY.md) - fixes
...
- [Credential Generation Type Safety Fix](./fixes/CREDENTIAL_GENERATION_TYPE_SAFETY_FIX.md) - fixes
...
- [Custom Field Columns - Quick Reference](./guides/CUSTOM_FIELD_COLUMNS_QUICK_REFERENCE.md) - guides
...
- [Custom Fields API Enhancements Summary](./fixes/CUSTOM_FIELDS_ENHANCEMENTS_SUMMARY.md) - fixes
...
- [Field Update Service Guide](./guides/FIELD_UPDATE_SERVICE_GUIDE.md) - guides
...
- [Integration Data Flow](./guides/INTEGRATION_DATA_FLOW.md) - guides
- [Integration Migration Patterns](./guides/INTEGRATION_MIGRATION_PATTERNS.md) - guides
- [Integration Patterns Reference](./guides/INTEGRATION_PATTERNS_REFERENCE.md) - guides
- [Integration Security Guide](./guides/INTEGRATION_SECURITY_GUIDE.md) - guides
- [Integration Troubleshooting Guide](./guides/INTEGRATION_TROUBLESHOOTING_GUIDE.md) - guides
- [Integration Type Examples](./guides/INTEGRATION_TYPE_EXAMPLES.md) - guides
- [Integration UI Patterns](./guides/INTEGRATION_UI_PATTERNS.md) - guides
- [JSON Parsing Error Handling Fix](./fixes/JSON_PARSING_ERROR_HANDLING_FIX.md) - fixes
- [Link User Integration Guide](./misc/LINK_USER_INTEGRATION.md) - misc
- [Load Report Delete Race Condition Fix](./fixes/LOAD_REPORT_DELETE_RACE_CONDITION_FIX.md) - fixes
- [Load Report Edit Form Duplicate Submission Fix](./fixes/LOAD_REPORT_EDIT_FORM_DUPLICATE_SUBMISSION_FIX.md) - fixes
...
- [Major Updates Findings and Recommendations](./misc/MAJOR_UPDATES_FINDINGS_AND_RECOMMENDATIONS.md) - misc
...
- [Mobile Custom Fields Enhancement Summary](./guides/MOBILE_CUSTOM_FIELDS_ENHANCEMENT.md) - guides
- [Mobile Settings Passcode Implementation Guide](./guides/MOBILE_SETTINGS_PASSCODE_IMPLEMENTATION_GUIDE.md) - guides
- [Mock Query Permission Escaping Fix](./fixes/MOCK_QUERY_PERMISSION_ESCAPING_FIX.md) - fixes
- [Monitoring API Permission Fix](./fixes/MONITORING_API_PERMISSION_FIX.md) - fixes
- [Multi-Select Filter Implementation Summary](./fixes/MULTI_SELECT_IMPLEMENTATION_SUMMARY.md) - fixes
...
- [Operator Monitoring Descriptions Enhancement](./enhancements/OPERATOR_MONITORING_DESCRIPTIONS_ENHANCEMENT.md) - enhancements
- [Operator Monitoring User Guide](./guides/OPERATOR_MONITORING_USER_GUIDE.md) - guides
- [Optimistic Lock retriesUsed Accuracy Fix](./fixes/OPTIMISTIC_LOCK_RETRIES_USED_ACCURACY_FIX.md) - fixes
- [Package Updates Analysis](./misc/PACKAGE_UPDATES_ANALYSIS.md) - misc
- [Package Updates Quick Reference](./guides/PACKAGE_UPDATES_QUICK_REFERENCE.md) - guides
...
- [Pagination Offset Deletion Bug Fix](./fixes/PAGINATION_OFFSET_DELETION_BUG_FIX.md) - fixes
...
- [Report Correction JSON Parse Optimization](./fixes/REPORT_CORRECTION_JSON_PARSE_OPTIMIZATION.md) - fixes
- [Report Correction Replacement Dropdown Fix](./fixes/REPORT_CORRECTION_REPLACEMENT_DROPDOWN_FIX.md) - fixes
- [Report Correction Silent Replacement Failure Fix](./fixes/REPORT_CORRECTION_SILENT_REPLACEMENT_FAILURE_FIX.md) - fixes
- [Report Correction Stale Field Removal Fix](./fixes/REPORT_CORRECTION_STALE_FIELD_REMOVAL_FIX.md) - fixes
- [Resizable Component Ref Override Fix](./fixes/RESIZABLE_COMPONENT_REF_OVERRIDE_FIX.md) - fixes
- [Role Permissions Validation Fix](./fixes/ROLE_PERMISSIONS_VALIDATION_FIX.md) - fixes
...
- [Saved Reports Custom Field Validation Fix](./fixes/SAVED_REPORTS_CUSTOM_FIELD_VALIDATION_FIX.md) - fixes
- [Saved Reports Duplicate Name Handling Fix](./fixes/SAVED_REPORTS_DUPLICATE_NAME_HANDLING_FIX.md) - fixes
- [Saved Reports Empty Custom Fields Fix](./fixes/SAVED_REPORTS_EMPTY_CUSTOM_FIELDS_FIX.md) - fixes
- [Saved Reports Feature Guide](./guides/SAVED_REPORTS_GUIDE.md) - guides
- [Saved Reports Feature Implementation](./enhancements/SAVED_REPORTS_FEATURE_IMPLEMENTATION.md) - enhancements
- [Saved Reports Malformed filterConfiguration Fix](./fixes/SAVED_REPORTS_MALFORMED_FILTERCONFIGURATION_FIX.md) - fixes
- [Saved Reports Permission Fix](./fixes/SAVED_REPORTS_PERMISSION_FIX.md) - fixes
- [Setup Appwrite Helper Extraction](./misc/SETUP_APPWRITE_HELPER_EXTRACTION.md) - misc
- [SweetAlert2 Best Practices Guide](./guides/SWEETALERT_BEST_PRACTICES_GUIDE.md) - guides
- [SweetAlert2 Customization Guide](./guides/SWEETALERT_CUSTOMIZATION_GUIDE.md) - guides
- [SweetAlert2 Progress Modal - Quick Reference](./enhancements/SWEETALERT_PROGRESS_QUICK_REFERENCE.md) - enhancements
- [SweetAlert2 Progress Modals - Implementation Summary](./enhancements/SWEETALERT_PROGRESS_IMPLEMENTATION_SUMMARY.md) - enhancements
- [SweetAlert2 Usage Guide](./guides/SWEETALERT_USAGE_GUIDE.md) - guides
...
- [TablesDB Migration Stale References Fix](./fixes/TABLESDB_MIGRATION_STALE_REFERENCES_FIX.md) - fixes
- [TablesDB: updateRows vs upsertRows - Critical Difference](./misc/TABLESDB_UPDATE_VS_UPSERT.md) - misc
- [Test Files API Consistency and Indentation Fixes](./fixes/TEST_FILES_API_CONSISTENCY_FIX.md) - fixes
- [Time Until Event Display Enhancement](./enhancements/TIME_UNTIL_EVENT_DISPLAY_ENHANCEMENT.md) - enhancements
- [Transaction Monitoring Dashboard Empty-State Logic Fix](./fixes/TRANSACTION_MONITORING_EMPTY_STATE_LOGIC_FIX.md) - fixes
...
- [useUserFormState Test Expectations Fix](./fixes/USEFORMSTATE_TEST_EXPECTATIONS_FIX.md) - fixes
- [Vitest 4 Constructor Mocking Fix](./fixes/VITEST_4_CONSTRUCTOR_MOCKING_FIX.md) - fixes
...
- [Appwrite TablesDB API Migration to Named Parameters](./migration/APPWRITE_TABLESDB_API_MIGRATION.md) - migration
...
- [Integration Collections Migration](./migration/INTEGRATION_COLLECTIONS_MIGRATION.md) - migration
- [Integration Secrets Migration Guide](./migration/INTEGRATION_SECRETS_MIGRATION.md) - migration
- [Integration Version Attribute Implementation Summary](./migration/INTEGRATION_VERSION_ATTRIBUTE_SUMMARY.md) - migration
- [Integration Version Migration](./migration/INTEGRATION_VERSION_MIGRATION.md) - migration
- [Log Deletion Testing Guide](./testing/LOG_DELETION_TESTING_GUIDE.md) - testing
- [Log Settings Table Schema Migration](./migration/LOG_SETTINGS_SCHEMA_MIGRATION.md) - migration
- [Logs Timestamp Migration Summary](./migration/LOGS_TIMESTAMP_MIGRATION_SUMMARY.md) - migration
- [Major Package Updates Testing Plan](./misc/MAJOR_PACKAGE_UPDATES_TESTING_PLAN.md) - misc
- [Migration Script Validation Tests Summary](./migration/MIGRATION_VALIDATION_TESTS_SUMMARY.md) - migration
- [Migration Scripts Alignment Summary](./migration/MIGRATION_SCRIPTS_ALIGNMENT_SUMMARY.md) - migration
- [Quick Start: Testing Delete Logs](./testing/TESTING_QUICK_START.md) - testing
...
- [TablesDB Setup Scripts Migration](./migration/TABLESDB_SETUP_SCRIPTS_MIGRATION.md) - migration
- [Vitest 4.0.18 Upgrade Analysis](./migration/VITEST_4_0_18_UPGRADE_ANALYSIS.md) - migration
...
- [Framer Motion 12.29.2 Update Test Results](./testing/FRAMER_MOTION_UPDATE_TEST_RESULTS.md) - testing
- [Invitation API Tests Summary](./testing/INVITATION_API_TESTS_SUMMARY.md) - testing
- [Logging System Integration Tests - Implementation Summary](./testing/LOGS_API_TESTS_SUMMARY.md) - testing
- [Major Package Updates Testing Complete](./misc/MAJOR_PACKAGE_UPDATES_TESTING_COMPLETE.md) - misc
- [Mobile Settings Passcode - Test Summary](./testing/MOBILE_SETTINGS_PASSCODE_TESTS_SUMMARY.md) - testing
- [Node-Appwrite 21.1.0 Update Test Results](./testing/NODE_APPWRITE_UPDATE_TEST_RESULTS.md) - testing
...
- [Package Updates Completion Summary](./misc/PACKAGE_UPDATES_COMPLETION_SUMMARY.md) - misc
...
- [Session Summary - Dependency Updates & Vitest Upgrade](./misc/SESSION_SUMMARY_DEPENDENCY_UPDATES.md) - misc
- [Steering Update Summary](./STEERING_UPDATE_SUMMARY.md) - docs
- [TablesDB Migration Property Tests Summary](./testing/TABLESDB_MIGRATION_PROPERTY_TESTS_SUMMARY.md) - testing
...
- [Vitest 4.0.18 Upgrade Summary](./migration/VITEST_4_UPGRADE_SUMMARY.md) - migration
