 ...
 * - Viewer: read
 *
 * Usage: npx ts-node --esm scripts/archive/pre-tablesdb/add-reports-permissions.ts
 */
...
function validateEnvironment(): {
  ...
  const rolesTableId = process.env.NEXT_PUBLIC_APPWRITE_ROLES_TABLE_ID || 'roles';
...
const { endpoint, projectId, apiKey, databaseId, rolesTableId } = validateEnvironment();
