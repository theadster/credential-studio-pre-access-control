 ...
 * Run with: npx ts-node scripts/test-appwrite-auth.ts
 */
...
if (!usersTableId) missingVars.push('NEXT_PUBLIC_APPWRITE_USERS_TABLE_ID');
...
console.log('- Users Collection ID:', usersTableId);
console.log('');
...
async function testConnection() {
  ...
  try {
    ...
    try {
      ...
      console.log('  Total users:', response.total ?? 'unknown');
    } catch (dbError: any) {
