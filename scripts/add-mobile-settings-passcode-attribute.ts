 ...
 * 
 * Usage:
 * npx tsx scripts/add-mobile-settings-passcode-attribute.ts
 */
...
async function main() {
  ...
  try {
    ...
    while (attempts < maxAttempts) {
      try {
        const attribute: any = await databases.getAttribute(databaseId, collectionId, 'mobileSettingsPasscode');
